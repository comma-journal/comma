...
const TodayEditor: React.FC = () => {
  ...
  const [styledSegments, setStyledSegments] = useState<StyledTextSegment[]>([]);
  ...
  // 선택된 텍스트에 스타일 적용
  const applyStyleToSelection = (styleProperty: keyof TextStyle, styleValue: any) => {
    ...
    // 새로운 스타일 세그먼트 생성
    const newSegment: StyledTextSegment = {
      text: selectedText,
