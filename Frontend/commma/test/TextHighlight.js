// src/components/TextHighlight.js
...
const TextHighlight = () => {
    ...
    // 말풍선 클릭 핸들러
    const handleBubblePress = (bubbleWithSentence) => {
    ...
    const getHighlightForSentence = (paragraphIndex, sentenceIndex) => {
        return highlightData.find(
            highlight => highlight.paragraph === paragraphIndex && highlight.sentence === sentenceIndex
        );
    };

    const getBubblesForSentence = (paragraphIndex, sentenceIndex) => {
